...
echo.
echo Enter 1  for 100%%
echo Enter 2 for 125%%
echo Enter 3 for 150%%
echo Enter 4 for 200%%  (Good for 4K monitors)
echo Enter 5 for 300%%  (Good for Surface Tablets where someone normally needs 150%%)
echo Enter 6 for 400%%  (Cannot think of any ideal use for this.)
echo.
